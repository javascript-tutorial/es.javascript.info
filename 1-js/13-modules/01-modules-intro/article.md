...
A medida que nuestra aplicación crece, queremos dividirla en múltiples archivos, llamados "módulos". Un módulo contener una clase o una biblioteca de funciones para un propósito específico.
