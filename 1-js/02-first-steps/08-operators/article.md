...
El hecho de que `=` sea un operador, no un construcción "mágica" del lenguaje tiene un implicancia interesante.
...
a = c;
```
Es más fácil de leer, especialmente cuando se hace un rápido vistazo.
