...
Hay una convención extendida que propiedades y métodos que comienzan con guion bajo`_` son de uso interno. Ellos no deberían ser accedidos desde fuera del objeto.
...
// después de esta envoltiura, llamados a sayHi serán demorados por 3 segundos
