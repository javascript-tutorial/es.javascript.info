...
Los códigos de WebSocket son como los de HTTP, pero con diferencias: En particular, los códigos menores a `1000` son reservados, habrá un error si tratamos de establecerlos.
