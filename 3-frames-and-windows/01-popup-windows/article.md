...
...Y eso abrirá una nueva ventana con una URL. El navegador más moderno está configurado para abrir pestañas nuevas en vez de ventanas separadas.
...
Para prevenir el abuso, el navegador suele bloquear estos métodos. Sólo funcionan de forma fiable en los popups que hemos abierto, que no tienen pestañas adicionales.
...
- La ventana principal y la ventana emergente pueden leerse y modificarse libremente entre sí si tienen el mismo origen. De lo contrario, pueden cambiar de ubicación e [intercambiar mensajes] (información: comunicación entre ventanas).
