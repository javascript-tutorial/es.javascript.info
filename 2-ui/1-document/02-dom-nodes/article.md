...
El texto dentro de los elementos forma *nodos de texto*, etiquetados como `#text`. Un nodo de texto contiene solo una cadena. Este no puede tener hijos, siempre es una hoja del árbol.
